...
public class Config {
    ...
    private static final ForgeConfigSpec.IntValue FORGE_MAX_DELAY_TIME = BUILDER.comment(" ").comment("The max maid forge delay time").comment("Default 20").comment("女仆锻造最长延时").defineInRange("maxDelayTimeToForge", 10, 0, Integer.MAX_VALUE);
